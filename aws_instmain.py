...
while True:
  ...
  if (s=='1'):
     ...
     ec2 = boto3.client('ec2',aws_access_key_id='%s'%(aakey),aws_secret_access_key='%s'%(askey),region_name='ap-south-1')
     ...
     for regi in regionlist:
      ...
      if (os=='1'):
             imageid=aimageid[0]
             responce=launch(client,imageid,instkey)
             print responce
  ...
  print "#########again to choice or cltr+c to connection close"
